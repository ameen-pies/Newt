...
/**
 * Procedural 3D avatar — capsule body with animated head/eyes.
 * No external model files needed for MVP.
 */
    ...
    <group ref={groupRef} position={[0, 1.0, 0]}>
      ...
      <mesh position={[0, -0.3, 0]}>
        ...
        <meshStandardMaterial
          ...
          emissiveIntensity={moodIntensity}
          roughness={0.3}
          metalness={0.7}
        />
      </mesh>
      ...
      <mesh position={[0, 0.9, 0]}>
        ...
        <meshStandardMaterial
          color={eyeColor}
          emissive={eyeColor}
          emissiveIntensity={isThinking ? 1.5 : 0.5}
        />
      </mesh>
    </group>
  );
